...
class EditDialog(QDialog):
    def __init__(
        ...
        self._args_entry: QTextEdit = QTextEdit(
            "<p>" + "</p><p>".join(self.args) + "</p>", self
        )
        ...
        self._buttons.button(QDialogButtonBox.StandardButton.Ok).setEnabled(
            self._exe_entry.valid and bool(alias)
        )
    ...
    def on_alias_changed(self, new_alias: str) -> None:
        self._buttons.button(QDialogButtonBox.StandardButton.Ok).setEnabled(
            bool(new_alias) and self._exe_entry.valid
        )

    def on_exe_changed(self, valid: bool) -> None:
        self._buttons.button(QDialogButtonBox.StandardButton.Ok).setEnabled(
            valid and bool(self._alias_entry.text())
        )
